...
<table>
	...
	<tr style="text-align:left">
		<td>Gaming Activities<span style="color:darkred;vertical-align:super;font-family:'Century Gothic';font-size:75%"> &diams;</span></td>
		<td style="color:darkred">Chip Walking</td>
	</tr>
	<tr style="text-align:left">
		<td style="padding: 0px 0px 15px 0px;">Gaming Activities<span style="color:darkred;vertical-align:super;font-family:'Century Gothic';font-size:75%"> &diams;</span></td>
	...
	<tr style="text-align:left">
		<td>Cyber Event<span style="color:darkred;vertical-align:super;font-family:'Century Gothic';font-size:75%"> &diams;&diams;</span></td>
...
<span style="color:darkred;vertical-align:super;font-family:'Century Gothic';font-size:75%">&diams; </span><span style="font-size:12px">New Header (replaces Casinos)</span>
<p><span style="color:darkred;vertical-align:super;font-family:'Century Gothic';font-size:75%">&diams;&diams; </span><span style="font-size:12px">New Category</span></p> 
	...
	<div id="formInputs">
		...
		<div id="formButtonContainer">
			<div id="formButtons">
				...
				<form action="https://www.fincen.gov/fcn/Reports/SARStats" method="GET"><button type="submit" id="submit" class="formButton btn btn-primary"><span class='fa fa-search'></span><span>Generate</span></button>
