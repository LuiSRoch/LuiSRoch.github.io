...
<script>
  ...
  {%- endif -%}
      ...
      Je suis actuellement membre d’un groupe d’échanges sur l’intelligence artificielle dans lequel nous discutons de pratiques d’entreprises, de ce qu’il y a à l’intérieur de la « boîte noire » (calculs mathématiques) tout autant que d’éthique et des impacts de l’IA sur la société et le marché du travail.
       ...
       Dernière mise à jour des données et des liens :
        <br />
        ...
        <div class="proj-box-format">
          <iframe height="25" scrolling="no" src="https://fr.dailyforex.com/forex-widget/widget/29824" style="width: 100%; height:25px; display: block;border:0px;overflow:hidden;" width="100%">
          </iframe><span style="position:relative;display:block;text-align:center;color:#333333;width:100%;font-family:Tahoma,sans-serif;font-size:10px;"></span>
        </div>
        <hr><hr><br />
